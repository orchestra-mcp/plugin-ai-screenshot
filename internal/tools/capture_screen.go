...
// CaptureScreenSchema returns the JSON Schema for the capture_screen tool.
func CaptureScreenSchema() *structpb.Struct {
...
// CaptureScreen returns a tool handler that captures the entire screen.
func CaptureScreen() func(ctx context.Context, req *pluginv1.ToolRequest) (*pluginv1.ToolResponse, error) {
	return func(ctx context.Context, req *pluginv1.ToolRequest) (*pluginv1.ToolResponse, error) {
		...
		if err := capture.CaptureScreen(outputPath); err != nil {
			return helpers.ErrorResult("capture_error", fmt.Sprintf("failed to capture screen: %v", err)), nil
		}
